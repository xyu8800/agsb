...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "moyy"         # 用户名
UUID = "5d87b592-7c50-4395-9397-e1dfe84ca27b"                     # UUID，留空则自动生成
PORT = 50001                   # Vmess端口，留空或0则自动生成
DOMAIN = "str.xiaoyu9.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMmM3YTEwNzc0MjFjNDU1OGQwZmQ5NTJlYjJkN2I1ZjgiLCJ0IjoiOTQ2YjZhYzQtMWJiNC00ODk0LWI2MjktZjAzNDY2NmVjY2Q1IiwicyI6Ik5HSTJNamxsTjJZdE5UTmtOQzAwTkdSbUxXRTVaakl0TmpjeE9HRmxNbUZoWlRrNSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
